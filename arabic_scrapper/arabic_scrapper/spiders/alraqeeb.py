...
news_sites_list,categories_english,main_category,sub_category,platform,media_type,urgency = load_dataset_lists("AlraqeebNews",False)
now = datetime_now_isoformat()

class AlraqeebNewsSpider(scrapy.Spider):
    name = 'AlraqeebNews'

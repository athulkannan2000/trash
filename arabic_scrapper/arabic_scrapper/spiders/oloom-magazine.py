...
news_sites_list,categories_english,main_category,sub_category,platform,media_type,urgency = load_dataset_lists("oloom magazine",False)
now = datetime_now_isoformat()

class OloomMagazineSpider(scrapy.Spider):
    name = 'oloom-magazine'
